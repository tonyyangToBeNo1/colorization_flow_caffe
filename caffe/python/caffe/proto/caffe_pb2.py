...
_STORAGEFORMAT = _descriptor.EnumDescriptor(
  name='StorageFormat',
  full_name='caffe.StorageFormat',
  filename=None,
  file=DESCRIPTOR,
  values=[
    _descriptor.EnumValueDescriptor(
...
_sym_db.RegisterEnumDescriptor(_STORAGEFORMAT)

StorageFormat = enum_type_wrapper.EnumTypeWrapper(_STORAGEFORMAT)
TRAIN = 0
TEST = 1
FLOAT16 = 0
FLOAT32 = 1
...
_COLORCONVPARAMETER_COLORSPACE = _descriptor.EnumDescriptor(
  name='ColorSpace',
  full_name='caffe.ColorConvParameter.ColorSpace',
  filename=None,
  file=DESCRIPTOR,
  values=[
    _descriptor.EnumValueDescriptor(
    ...
    _descriptor.EnumValueDescriptor(
      ...
      type=None),
    _descriptor.EnumValueDescriptor(
      name='XYZ', index=2, number=2,
      options=None,
      type=None),
    _descriptor.EnumValueDescriptor(
      name='Lab', index=3, number=3,
      options=None,
      type=None),
    _descriptor.EnumValueDescriptor(
...
_sym_db.RegisterEnumDescriptor(_COLORCONVPARAMETER_COLORSPACE)
...
_FLOWWARPPARAMETER_FILLPARAMETER = _descriptor.EnumDescriptor(
  name='FillParameter',
  full_name='caffe.FlowWarpParameter.FillParameter',
  filename=None,
  file=DESCRIPTOR,
  values=[
    _descriptor.EnumValueDescriptor(
...
_REPACKPARAMETER_OPERATION = _descriptor.EnumDescriptor(
  name='Operation',
  full_name='caffe.RepackParameter.Operation',
  filename=None,
  file=DESCRIPTOR,
  values=[
    _descriptor.EnumValueDescriptor(
      name='PACK_IMAGE', index=0, number=0,
      options=None,
      type=None),
    _descriptor.EnumValueDescriptor(
      name='UNPACK_IMAGE', index=1, number=1,
      options=None,
      type=None),
  ],
  containing_type=None,
...
_sym_db.RegisterEnumDescriptor(_REPACKPARAMETER_OPERATION)
...
_LAYERPARAMETER = _descriptor.Descriptor(
  ...
  fields=[
    ...
    _descriptor.FieldDescriptor(
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='color_conv_param', full_name='caffe.LayerParameter.color_conv_param', index=21,
    ...
    _descriptor.FieldDescriptor(
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='fast_hdf5_input_param', full_name='caffe.LayerParameter.fast_hdf5_input_param', index=29,
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='fast_hdf5_output_param', full_name='caffe.LayerParameter.fast_hdf5_output_param', index=30,
    ...
    _descriptor.FieldDescriptor(
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='repack_param', full_name='caffe.LayerParameter.repack_param', index=49,
    ...
    _descriptor.FieldDescriptor(
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='resize_param', full_name='caffe.LayerParameter.resize_param', index=52,
    ...
    _descriptor.FieldDescriptor(
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='matrix_mul_param', full_name='caffe.LayerParameter.matrix_mul_param', index=61,
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='image_data_modify_param', full_name='caffe.LayerParameter.image_data_modify_param', index=62,
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='interp_param', full_name='caffe.LayerParameter.interp_param', index=63,
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='split_data_param', full_name='caffe.LayerParameter.split_data_param', index=64,
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='generator_param', full_name='caffe.LayerParameter.generator_param', index=65,
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='flow_warp_param', full_name='caffe.LayerParameter.flow_warp_param', index=66,
...
_TRANSFORMATIONPARAMETER = _descriptor.Descriptor(
  ...
  fields=[
    ...
    _descriptor.FieldDescriptor(
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='min_scale', full_name='caffe.TransformationParameter.min_scale', index=7,
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='max_scale', full_name='caffe.TransformationParameter.max_scale', index=8,
      number=9, type=2, cpp_type=6, label=1,
      has_default_value=True, default_value=float(1),
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      options=None),
    _descriptor.FieldDescriptor(
      name='rotate', full_name='caffe.TransformationParameter.rotate', index=9,
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='synchronized', full_name='caffe.TransformationParameter.synchronized', index=10,
...
_COLORCONVPARAMETER = _descriptor.Descriptor(
  name='ColorConvParameter',
  full_name='caffe.ColorConvParameter',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  fields=[
    _descriptor.FieldDescriptor(
      name='input', full_name='caffe.ColorConvParameter.input', index=0,
      number=1, type=14, cpp_type=8, label=1,
      has_default_value=True, default_value=0,
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      options=None),
    _descriptor.FieldDescriptor(
      name='output', full_name='caffe.ColorConvParameter.output', index=1,
      number=2, type=14, cpp_type=8, label=1,
      has_default_value=True, default_value=0,
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
  ...
  nested_types=[],
  enum_types=[
    _COLORCONVPARAMETER_COLORSPACE,
  ],
  options=None,
  is_extendable=False,
  syntax='proto2',
...
_FASTHDF5INPUTPARAMETER = _descriptor.Descriptor(
  name='FastHDF5InputParameter',
  full_name='caffe.FastHDF5InputParameter',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  fields=[
    _descriptor.FieldDescriptor(
      name='source', full_name='caffe.FastHDF5InputParameter.source', index=0,
      number=1, type=9, cpp_type=9, label=1,
      has_default_value=False, default_value=_b("").decode('utf-8'),
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      options=None),
    _descriptor.FieldDescriptor(
      name='batch_size', full_name='caffe.FastHDF5InputParameter.batch_size', index=1,
      number=2, type=5, cpp_type=1, label=1,
      has_default_value=False, default_value=0,
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      options=None),
    _descriptor.FieldDescriptor(
      name='group_name', full_name='caffe.FastHDF5InputParameter.group_name', index=2,
      number=3, type=9, cpp_type=9, label=3,
      has_default_value=False, default_value=[],
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
...
_FASTHDF5OUTPUTPARAMETER = _descriptor.Descriptor(
  name='FastHDF5OutputParameter',
  full_name='caffe.FastHDF5OutputParameter',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  fields=[
    _descriptor.FieldDescriptor(
      name='file_name', full_name='caffe.FastHDF5OutputParameter.file_name', index=0,
      number=1, type=9, cpp_type=9, label=1,
      has_default_value=False, default_value=_b("").decode('utf-8'),
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      options=None),
    _descriptor.FieldDescriptor(
      name='storage', full_name='caffe.FastHDF5OutputParameter.storage', index=1,
      number=2, type=14, cpp_type=8, label=1,
      has_default_value=True, default_value=0,
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      options=None),
    _descriptor.FieldDescriptor(
      name='group_name', full_name='caffe.FastHDF5OutputParameter.group_name', index=2,
      number=3, type=9, cpp_type=9, label=3,
      has_default_value=False, default_value=[],
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
...
_GENERATORPARAMETER = _descriptor.Descriptor(
  name='GeneratorParameter',
  full_name='caffe.GeneratorParameter',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  fields=[
...
_FLOWWARPPARAMETER = _descriptor.Descriptor(
  ...
  full_name='caffe.FlowWarpParameter',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  fields=[
    _descriptor.FieldDescriptor(
      name='fill_value', full_name='caffe.FlowWarpParameter.fill_value', index=0,
      number=1, type=14, cpp_type=8, label=1,
      has_default_value=True, default_value=1,
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
...
_IMAGEDATAMODIFYPARAMETER = _descriptor.Descriptor(
  name='ImageDataModifyParameter',
  full_name='caffe.ImageDataModifyParameter',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  fields=[
    _descriptor.FieldDescriptor(
      name='source', full_name='caffe.ImageDataModifyParameter.source', index=0,
      number=1, type=9, cpp_type=9, label=1,
      has_default_value=False, default_value=_b("").decode('utf-8'),
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      options=None),
    _descriptor.FieldDescriptor(
      name='batch_size', full_name='caffe.ImageDataModifyParameter.batch_size', index=1,
      number=4, type=13, cpp_type=3, label=1,
      has_default_value=True, default_value=1,
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      options=None),
    _descriptor.FieldDescriptor(
      name='rand_skip', full_name='caffe.ImageDataModifyParameter.rand_skip', index=2,
      number=7, type=13, cpp_type=3, label=1,
      has_default_value=True, default_value=0,
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      options=None),
    _descriptor.FieldDescriptor(
      name='shuffle', full_name='caffe.ImageDataModifyParameter.shuffle', index=3,
      number=8, type=8, cpp_type=7, label=1,
      has_default_value=True, default_value=False,
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      options=None),
    _descriptor.FieldDescriptor(
      name='new_height', full_name='caffe.ImageDataModifyParameter.new_height', index=4,
      number=9, type=13, cpp_type=3, label=1,
      has_default_value=True, default_value=0,
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      options=None),
    _descriptor.FieldDescriptor(
      name='new_width', full_name='caffe.ImageDataModifyParameter.new_width', index=5,
      number=10, type=13, cpp_type=3, label=1,
      has_default_value=True, default_value=0,
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      options=None),
    _descriptor.FieldDescriptor(
      name='is_color', full_name='caffe.ImageDataModifyParameter.is_color', index=6,
      number=11, type=8, cpp_type=7, label=1,
      has_default_value=True, default_value=True,
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      options=None),
    _descriptor.FieldDescriptor(
      name='scale', full_name='caffe.ImageDataModifyParameter.scale', index=7,
      number=2, type=2, cpp_type=6, label=1,
      has_default_value=True, default_value=float(1),
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      options=None),
    _descriptor.FieldDescriptor(
      name='mean_file', full_name='caffe.ImageDataModifyParameter.mean_file', index=8,
      number=3, type=9, cpp_type=9, label=1,
      has_default_value=False, default_value=_b("").decode('utf-8'),
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      options=None),
    _descriptor.FieldDescriptor(
      name='crop_size', full_name='caffe.ImageDataModifyParameter.crop_size', index=9,
      number=5, type=13, cpp_type=3, label=1,
      has_default_value=True, default_value=0,
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      options=None),
    _descriptor.FieldDescriptor(
      name='mirror', full_name='caffe.ImageDataModifyParameter.mirror', index=10,
      number=6, type=8, cpp_type=7, label=1,
      has_default_value=True, default_value=False,
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      options=None),
    _descriptor.FieldDescriptor(
      name='root_folder', full_name='caffe.ImageDataModifyParameter.root_folder', index=11,
      number=12, type=9, cpp_type=9, label=1,
      has_default_value=True, default_value=_b("").decode('utf-8'),
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
...
_SPLITDATAPARAMETER = _descriptor.Descriptor(
  name='SplitDataParameter',
  full_name='caffe.SplitDataParameter',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  fields=[
    _descriptor.FieldDescriptor(
      name='frame', full_name='caffe.SplitDataParameter.frame', index=0,
      number=1, type=5, cpp_type=1, label=1,
      has_default_value=True, default_value=1,
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
...
_REPACKPARAMETER = _descriptor.Descriptor(
  name='RepackParameter',
  full_name='caffe.RepackParameter',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  fields=[
    _descriptor.FieldDescriptor(
      name='operation', full_name='caffe.RepackParameter.operation', index=0,
      number=1, type=14, cpp_type=8, label=1,
      has_default_value=True, default_value=0,
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      options=None),
    _descriptor.FieldDescriptor(
      name='stride', full_name='caffe.RepackParameter.stride', index=1,
      number=2, type=13, cpp_type=3, label=1,
      has_default_value=True, default_value=1,
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      options=None),
    _descriptor.FieldDescriptor(
      name='stride_h', full_name='caffe.RepackParameter.stride_h', index=2,
      number=3, type=13, cpp_type=3, label=1,
      has_default_value=False, default_value=0,
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      options=None),
    _descriptor.FieldDescriptor(
      name='stride_w', full_name='caffe.RepackParameter.stride_w', index=3,
      number=4, type=13, cpp_type=3, label=1,
      has_default_value=False, default_value=0,
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
...
_RESIZEPARAMETER = _descriptor.Descriptor(
  ...
  fields=[
    ...
    _descriptor.FieldDescriptor(
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='scale', full_name='caffe.ResizeParameter.scale', index=2,
      number=3, type=2, cpp_type=6, label=1,
      has_default_value=False, default_value=float(0),
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      options=None),
    _descriptor.FieldDescriptor(
      name='scale_x', full_name='caffe.ResizeParameter.scale_x', index=3,
      number=4, type=2, cpp_type=6, label=1,
      has_default_value=False, default_value=float(0),
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      options=None),
    _descriptor.FieldDescriptor(
      name='scale_y', full_name='caffe.ResizeParameter.scale_y', index=4,
      number=5, type=2, cpp_type=6, label=1,
      has_default_value=False, default_value=float(0),
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      options=None),
    _descriptor.FieldDescriptor(
      name='crop', full_name='caffe.ResizeParameter.crop', index=5,
      number=6, type=2, cpp_type=6, label=1,
      has_default_value=True, default_value=float(0),
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      options=None),
    _descriptor.FieldDescriptor(
      name='crop_x', full_name='caffe.ResizeParameter.crop_x', index=6,
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='crop_y', full_name='caffe.ResizeParameter.crop_y', index=7,
      number=8, type=2, cpp_type=6, label=1,
      has_default_value=False, default_value=float(0),
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
...
_MATRIXMULPARAMETER = _descriptor.Descriptor(
  ...
  full_name='caffe.MatrixMulParameter',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  fields=[
    _descriptor.FieldDescriptor(
      name='num_streams', full_name='caffe.MatrixMulParameter.num_streams', index=0,
      number=1, type=13, cpp_type=3, label=1,
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='use_streams', full_name='caffe.MatrixMulParameter.use_streams', index=1,
      number=2, type=8, cpp_type=7, label=1,
      has_default_value=True, default_value=True,
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      options=None),
    _descriptor.FieldDescriptor(
      name='transpose_0', full_name='caffe.MatrixMulParameter.transpose_0', index=2,
      number=3, type=8, cpp_type=7, label=1,
      has_default_value=True, default_value=False,
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      options=None),
    _descriptor.FieldDescriptor(
      name='transpose_1', full_name='caffe.MatrixMulParameter.transpose_1', index=3,
      number=4, type=8, cpp_type=7, label=1,
      has_default_value=True, default_value=False,
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
...
_LAYERPARAMETER.fields_by_name['color_conv_param'].message_type = _COLORCONVPARAMETER
...
_LAYERPARAMETER.fields_by_name['fast_hdf5_input_param'].message_type = _FASTHDF5INPUTPARAMETER
_LAYERPARAMETER.fields_by_name['fast_hdf5_output_param'].message_type = _FASTHDF5OUTPUTPARAMETER
...
_LAYERPARAMETER.fields_by_name['repack_param'].message_type = _REPACKPARAMETER
...
_LAYERPARAMETER.fields_by_name['image_data_modify_param'].message_type = _IMAGEDATAMODIFYPARAMETER
_LAYERPARAMETER.fields_by_name['interp_param'].message_type = _INTERPPARAMETER
_LAYERPARAMETER.fields_by_name['split_data_param'].message_type = _SPLITDATAPARAMETER
_LAYERPARAMETER.fields_by_name['generator_param'].message_type = _GENERATORPARAMETER
...
_COLORCONVPARAMETER.fields_by_name['input'].enum_type = _COLORCONVPARAMETER_COLORSPACE
_COLORCONVPARAMETER.fields_by_name['output'].enum_type = _COLORCONVPARAMETER_COLORSPACE
_COLORCONVPARAMETER_COLORSPACE.containing_type = _COLORCONVPARAMETER
...
_FASTHDF5OUTPUTPARAMETER.fields_by_name['storage'].enum_type = _STORAGEFORMAT
...
_REPACKPARAMETER.fields_by_name['operation'].enum_type = _REPACKPARAMETER_OPERATION
_REPACKPARAMETER_OPERATION.containing_type = _REPACKPARAMETER
...
DESCRIPTOR.message_types_by_name['ColorConvParameter'] = _COLORCONVPARAMETER
...
DESCRIPTOR.message_types_by_name['FastHDF5InputParameter'] = _FASTHDF5INPUTPARAMETER
DESCRIPTOR.message_types_by_name['FastHDF5OutputParameter'] = _FASTHDF5OUTPUTPARAMETER
...
DESCRIPTOR.message_types_by_name['GeneratorParameter'] = _GENERATORPARAMETER
DESCRIPTOR.message_types_by_name['FlowWarpParameter'] = _FLOWWARPPARAMETER
DESCRIPTOR.message_types_by_name['ImageDataModifyParameter'] = _IMAGEDATAMODIFYPARAMETER
...
DESCRIPTOR.message_types_by_name['SplitDataParameter'] = _SPLITDATAPARAMETER
...
DESCRIPTOR.message_types_by_name['RepackParameter'] = _REPACKPARAMETER
...
DESCRIPTOR.enum_types_by_name['StorageFormat'] = _STORAGEFORMAT
...
ColorConvParameter = _reflection.GeneratedProtocolMessageType('ColorConvParameter', (_message.Message,), dict(
  DESCRIPTOR = _COLORCONVPARAMETER,
  __module__ = 'caffe_pb2'
  # @@protoc_insertion_point(class_scope:caffe.ColorConvParameter)
  ))
_sym_db.RegisterMessage(ColorConvParameter)
...
FastHDF5InputParameter = _reflection.GeneratedProtocolMessageType('FastHDF5InputParameter', (_message.Message,), dict(
  DESCRIPTOR = _FASTHDF5INPUTPARAMETER,
  __module__ = 'caffe_pb2'
  # @@protoc_insertion_point(class_scope:caffe.FastHDF5InputParameter)
  ))
_sym_db.RegisterMessage(FastHDF5InputParameter)

FastHDF5OutputParameter = _reflection.GeneratedProtocolMessageType('FastHDF5OutputParameter', (_message.Message,), dict(
  DESCRIPTOR = _FASTHDF5OUTPUTPARAMETER,
  __module__ = 'caffe_pb2'
  # @@protoc_insertion_point(class_scope:caffe.FastHDF5OutputParameter)
  ))
_sym_db.RegisterMessage(FastHDF5OutputParameter)
...
GeneratorParameter = _reflection.GeneratedProtocolMessageType('GeneratorParameter', (_message.Message,), dict(
  DESCRIPTOR = _GENERATORPARAMETER,
  __module__ = 'caffe_pb2'
  # @@protoc_insertion_point(class_scope:caffe.GeneratorParameter)
  ))
_sym_db.RegisterMessage(GeneratorParameter)
...
FlowWarpParameter = _reflection.GeneratedProtocolMessageType('FlowWarpParameter', (_message.Message,), dict(
  ...
  __module__ = 'caffe_pb2'
  # @@protoc_insertion_point(class_scope:caffe.FlowWarpParameter)
  ))
_sym_db.RegisterMessage(FlowWarpParameter)

ImageDataModifyParameter = _reflection.GeneratedProtocolMessageType('ImageDataModifyParameter', (_message.Message,), dict(
  DESCRIPTOR = _IMAGEDATAMODIFYPARAMETER,
  __module__ = 'caffe_pb2'
  # @@protoc_insertion_point(class_scope:caffe.ImageDataModifyParameter)
  ))
_sym_db.RegisterMessage(ImageDataModifyParameter)
...
SplitDataParameter = _reflection.GeneratedProtocolMessageType('SplitDataParameter', (_message.Message,), dict(
  DESCRIPTOR = _SPLITDATAPARAMETER,
  __module__ = 'caffe_pb2'
  # @@protoc_insertion_point(class_scope:caffe.SplitDataParameter)
  ))
_sym_db.RegisterMessage(SplitDataParameter)
...
RepackParameter = _reflection.GeneratedProtocolMessageType('RepackParameter', (_message.Message,), dict(
  DESCRIPTOR = _REPACKPARAMETER,
  __module__ = 'caffe_pb2'
  # @@protoc_insertion_point(class_scope:caffe.RepackParameter)
  ))
_sym_db.RegisterMessage(RepackParameter)
...
MatrixMulParameter = _reflection.GeneratedProtocolMessageType('MatrixMulParameter', (_message.Message,), dict(
  ...
  __module__ = 'caffe_pb2'
  # @@protoc_insertion_point(class_scope:caffe.MatrixMulParameter)
  ))
